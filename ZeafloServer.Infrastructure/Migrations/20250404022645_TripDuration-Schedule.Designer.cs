...
namespace ZeafloServer.Infrastructure.Migrations
{
    ...
    [Migration("20250404022645_TripDuration-Schedule")]
    partial class TripDurationSchedule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ZeafloServer.Domain.Entities.Place", b =>
                {
                    ...
                    b.ToTable("Places", t =>
                        {
                            t.HasCheckConstraint("CK_Place_Type", "type IN ('Restaurant', 'Coffee', 'Hotel', 'HomeStay', 'Resort')");
                        });
                });
